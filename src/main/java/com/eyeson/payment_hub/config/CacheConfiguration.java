package com.eyeson.payment_hub.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("GlobalPaymentHub");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("GlobalPaymentHub");
        ...
        config.getMapConfigs().put("com.eyeson.payment_hub.domain.*", initializeDomainMapConfig(jHipsterProperties));
