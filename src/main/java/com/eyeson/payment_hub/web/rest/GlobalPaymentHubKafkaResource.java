...
@RestController
@RequestMapping("/api/global-payment-hub-kafka")
public class GlobalPaymentHubKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GlobalPaymentHubKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GlobalPaymentHubKafkaResource(KafkaProperties kafkaProperties) {
